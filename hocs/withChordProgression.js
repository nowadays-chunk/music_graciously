...
const withChordProgression = (WrappedComponent) => {
    const WithChordProgression = (props) => {
    ...
    WithChordProgression.displayName = `WithChordProgression(${WrappedComponent.displayName || WrappedComponent.name || 'Component'})`;

    return WithChordProgression;
};
